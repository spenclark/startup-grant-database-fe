...
const UserTable = (props) => {
  ...
  const roleId = useSelector(
    (state) =>
      state.admin.roles.filter((role) => role.name === "Moderator")[0].id
  );
    ...
    <React.Fragment>
      ...
      <div>
        <div className={style.paper}>
          <a href="https://manage.auth0.com/dashboard/us/founder-grants/">
